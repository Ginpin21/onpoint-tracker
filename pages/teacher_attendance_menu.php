                    ...
                    <div class="col-4 mb-5">
                        ...
                        <div class="buttons">
                            <div class="radio green">
                                <input type="radio" id="<?php echo "present_$student[0]"?>"
                                    name="<?php echo "attendance_$student[0]"?>" value="P" required>
                                <label for="<?php echo "present_$student[0]"?>">Present</label>
                            </div>
                            <div class="radio yellow">
                                <input type="radio" id="<?php echo "late_$student[0]"?>"
                                    name="<?php echo "attendance_$student[0]"?>" value="L">
                                <label for="<?php echo "late_$student[0]"?>">Late</label>
                            </div>
                            <div class="radio red">
                                <input type="radio" id="<?php echo "absent_$student[0]"?>"
                                    name="<?php echo "attendance_$student[0]"?>" value="A">
