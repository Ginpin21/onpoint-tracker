...
?>
        ...
        <head>
            ...
            <?php if ($module_id) require_once('../inc/head.php'); ?>
            <style>
                .navbar {
                    padding: 10px
                }
        ...
        <body>
            ...
            SUM(attendance.attendance_status='P') as present,
            SUM(attendance.attendance_status='L') as late,
            SUM(attendance.attendance_status='A') as absent,
